...
public class GetById {
    ...
    @Step("Admin send GET HTTP request for Get Invoice by Id without login")
    public void sendHttpInvoiceByIdWithoutLogin(){
        SerenityRest.given().header("Content-Type", "application/json").get(adminSetGetApiForGetById());
    }
}
