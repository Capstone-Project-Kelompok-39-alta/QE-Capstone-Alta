...
public class RegisterSteps {
    ...
    public void adminSendPOSTHTTPRequestForRegisterWithNullData() {
        post.sendPostforRegisterWithNullData();
        
    }

    @Then("Admin receive invalid HTTP response code 500 for register")
    public void adminReceiveInvalidHTTPResponseCodeForRegister() {
        post.receiveCode500ForRegister();
        
    }

    @And("Admin receive message Internal Server Error for register")
    public void adminReceiveMessageInternalServerErrorForRegister() {
        post.receiveMessageInternalServerError();
    }
}
