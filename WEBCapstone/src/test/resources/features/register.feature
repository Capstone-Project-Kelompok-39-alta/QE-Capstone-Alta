@Register
  ...
  Scenario Outline: Register Scenario
    ...
    |                   |          |                     |             |register page|
    |imamrayhanekadinata|1233212244|imamrayhane@gmail.com|rayhangantenk|register page|
    |rayhanekadinata    |1233212244|imamrayhane@gmail.com|eaeaeaeaea   |register page|
